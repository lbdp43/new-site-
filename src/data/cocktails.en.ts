...
export const cocktailsEn: Record<string, CocktailEn> = {
  ...
  'philtre-eros': {
    ...
    description:
      "Strawberry, raspberry, mint, bubbles — a romantic cocktail that showcases the floral and tangy notes of La Flèche Ardente.",
    ingredients: [
      { item: 'La Flèche Ardente', amount: '4 cl' },
      { item: 'Strawberry juice', amount: '4 cl' },
      { item: 'Lemon juice (yellow or lime)', amount: '1 cl' },
      { item: 'Mint leaves', amount: '2' },
      { item: 'Ice cubes', amount: '3' },
      { item: 'Sparkling water', amount: '3 cl' },
    ],
    steps: [
      'In a shaker, add La Flèche Ardente, strawberry juice, lemon, mint leaves and ice cubes.',
      'Shake.',
      'Pour into a glass.',
