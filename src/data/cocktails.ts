...
export const cocktails: Cocktail[] = [
  ...
  },
  {
    ...
    description:
      "Fraise, framboise, menthe, bulles — un cocktail romantique qui met en valeur les notes florales et acidulées de la Flèche Ardente.",
    ...
    ingredients: [
      ...
      { item: "Jus de fraise", amount: "4 cl" },
      { item: "Jus de citron (vert ou jaune)", amount: "1 cl" },
      { item: "Feuilles de menthe", amount: "2" },
      { item: "Glaçons", amount: "3" },
      { item: "Eau pétillante", amount: "3 cl" },
    ],
    steps: [
      "Dans un shaker, ajouter la Flèche Ardente, le jus de fraise, le citron, les feuilles de menthe et les glaçons.",
      "Secouer.",
      "Verser dans un verre.",
      "Allonger avec l'eau pétillante.",
    ],
    prepTime: 'PT3M',
    servings: 1,
    glass: 'Long drink',
  ...
  },
  {
    ...
    name: 'Le Black Mule',
    description:
      "Relecture du Moscow Mule avec notre Gorgeon des Machurés — le baraban donne une amertume sombre, presque terreuse, qui fait merveille avec le gingembre.",
