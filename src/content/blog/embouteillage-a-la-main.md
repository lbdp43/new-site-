...
1. **Lavage bouteille** — semi-automatique (laveuse inox)
2. **Séchage bouteille** — à l'air chaud, dans la même machine
3. **Remplissage** — **manuel** pour les éditions limitées ; semi-automatique (4 becs en parallèle) pour les grandes séries, **toujours avec un opérateur** qui vérifie chaque bouteille
4. **Bouchage** — **100 % manuel**, bouchon en liège naturel, enfoncé à la capsuleuse à main
