...
/**
 * Animated scroll gallery — 3D tilt + parallax columns.
 * Adapté depuis https://21st.dev/community/components/YoucefBnm/animated-gallery
 *
 * Pattern : ContainerScroll > ContainerSticky > GalleryContainer > GalleryCol(s)
 * La galerie 3D se redresse (rotateX) puis défilement parallaxe des colonnes.
 */
  ...
  ({ className, transition, ...props }, ref) => {
    return (
      <motion.div
        ...
        transition={(transition ?? SPRING_CONFIG) as any}
        {...props}
      />
    );
  }
